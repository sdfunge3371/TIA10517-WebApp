...
<body>
              ...
              <tbody id="productTableBody">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <td>
                    <%=news.getNewsCategoryId()%>
                  </td>
                   <td>
                    <%=news.getNewsStartDate()%>
                  </td>
                   <td>
                    <%=news.getNewsEndDate()%>
                  </td>
  ...
  function confirmDelete(newsId) {
      if (confirm("確定刪除這則消息嗎？")) {
          // 使用表單提交，確保發送的是 POST 請求
          var form = document.createElement("form");
          form.setAttribute("method", "post");
          form.setAttribute("action", "${pageContext.request.contextPath}/uploadNewsServlet.do");
