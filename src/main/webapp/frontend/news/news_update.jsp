...
<%
  ...
  NewsVO news = newsSvc.getOneNews(newsId);
  if (news == null) {
    // 處理找不到新聞的情況
    out.println("找不到該消息");
    return;
          ...
          <div class="container mt-5">
            ...
            <form action="<%=request.getContextPath()%>/news/uploadNewsServlet.do" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="newsTitle" name="newsTitle" value="<%=news.getNewsTitle()%>"
                  required>
              </div>
              <div class="mb-3">
                <label for="newsContent" class="form-label">消息內容</label>
                <textarea class="form-control" id="newsContent" name="newsContent" rows="5"
                  required><%=news.getNewsContent()%></textarea>
              </div>
              <div class="mb-3">
                ...
                <select class="form-select" id="newsCategoryId" name="newsCategoryId" required>
                  <option value="NC001" <%= news.getNewsCategoryId() == "NC001" ? "selected" : "" %>>重要公告</option>
                  <option value="NC002" <%= news.getNewsCategoryId() == "NC002" ? "selected" : "" %>>活動</option>
                  <option value="NC003" <%= news.getNewsCategoryId() == "NC003" ? "selected" : "" %>>空間</option>
                </select>
              </div>
              <div class="mb-3">
