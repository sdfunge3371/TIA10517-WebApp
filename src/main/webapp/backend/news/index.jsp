...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="#" class="nav-item nav-link">常見問題</a>
        ...
        <div class="container-fluid header bg-white p-0">
            ...
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <!-- <div class="container">
                        <div class="row">
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                <strong><i class="bi bi-megaphone"></i> : 最新消息公告</strong>
                                <marquee>
                                    <p style="font-family: Impact; font-size: 18pt">四月連假限時優惠開跑囉~
                                        只要租賃超過6小時以上即可享有八折優惠
                                    </p>
                                </marquee>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="alert alert-danger alert-dismissible" role="alert" id="marquee-alert">
                                <strong><i class="bi bi-megaphone"></i> : 最新消息公告</strong>
                                <marquee id="marquee-content">
                                    <p style="font-family: Impact; font-size: 18pt">四月連假限時優惠開跑囉~
                                        只要租賃超過6小時以上即可享有八折優惠
                                    </p>
                                </marquee>
                    ...
                    <div class="modal fade" id="marqueeModal" tabindex="-1" role="dialog"
                        aria-labelledby="marqueeModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="marqueeModalLabel">最新消息公告</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body" id="marqueeModalBody">
                                </div>
                    ...
                    <h1 class="display-5 animated fadeIn mb-4">LifeSpace<span class="text-primary"> </span> </h1>
                    Introduction
                    <p class="animated fadeIn mb-4 pb-2">Vero elitr justo clita lorem. Ipsum dolor at sed stet
                        sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea elitr.</p>
                    <span><a href="" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">我要揪團</a>
                        <a href="" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">參與活動</a>
                        <a href="" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">租賃空間</a>
                    </span>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <div class="owl-carousel header-carousel">
                        <div class="owl-carousel-item">
                            <img class="img-fluid" src="./img/house1.jpg" alt="">
                        </div>
                        <div class="owl-carousel-item">
            ...
            <div class="container">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="./img/house5.jpg" alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
                                        <div
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="./img/house6.jpg" alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Sell</div>
                                        <div
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="./img/house7.jpg" alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
                                        <div
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="./img/house8.jpg" alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Sell</div>
                                        <div
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="./img/house1.jpg" alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
                                        <div
                    ...
                    <div id="tab-2" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="./img/house3.jpg" alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
                                        <div
                            ...
                            <div class="col-12 text-center">
                                <a class="btn btn-primary py-3 px-5" href="">查看更多租賃空間</a>
                            </div>
                        </div>
                    </div>
                    <div id="tab-3" class="tab-pane fade show p-0">
                        ...
                        <div class="col-12 text-center">
                            <a class="btn btn-primary py-3 px-5" href="">瀏覽更多最新消息</a>
                        </div>
                    </div>
                    ...
                    <br>
                    <div class="col-12 text-center">
                        <a class="btn btn-primary py-3 px-5" href="./news_list.html">瀏覽更多最新消息</a>
                    </div>
                    <!-- 最新消息表 end -->
        ...
        <!-- <button class="btn btn-primary mic-button" onclick="micButtonClick()">
